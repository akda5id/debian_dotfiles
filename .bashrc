...
alias gs="git status"
alias kg5k="~/bin/keep_going.py -f 5k.json"
alias kgcode="~/bin/keep_going.py -f xDaysOfCode.json"
alias kgmath="~/bin/keep_going.py -f math.json"
alias kgnpnm="~/bin/keep_going.py -f npnm.json"
